...
class ApiClient {
  ...
  static Future<ChopperClient> updateClient(String baseUrl) async {
    final authorizationEndpoint = Uri.parse('https://uat-auth.quickstoreapp.com:10442/connect/token');
    final identifier = 'QuickStore_App';
      ...
      chopper = ChopperClient(
        ...
        interceptors: [
          ...
          (Request request) async {
            ...
            mapUserSharedData = await userSharedData.getUserSharedPref() as Map<String, String>;
