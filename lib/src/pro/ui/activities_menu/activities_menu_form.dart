...
class ActivitiesMenuForm extends StatefulWidget {
  ...
  @override
  _ActivitiesMenuFormState createState() => _ActivitiesMenuFormState();
}

class _ActivitiesMenuFormState extends State<ActivitiesMenuForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppLocalization.of(context)!.translate('activities_menu_appbar_title') ?? "Activities Menu"),
        ...
        Expanded(
          child: Padding(
            ...
            child: Container(
              ...
              child: StreamBuilder(
                  stream: widget.desktopDao.watchAllActivitiesMenu(searchText, false, searchText, ""),
                      ...
                      return toggleList
                              ...
                              child: Wrap(direction: Axis.horizontal, alignment: WrapAlignment.start, children: [
                                ...prefData!.map((e) {
                                  return InkWell(
                                      onTap: () async {
                                        addItemBloc.setOrderNumber();
                                        Navigator.pushNamed(context, e.navigationRoute, arguments: widget.journeyWithAddress);
                                      },
                                      child: Padding(
                                            ...
                                            children: [
                                              Card(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Icon(IconData(int.parse(e.iconCode), fontFamily: e.iconFamily), color: Colors.white),
                                                ),
                                              ),
                                              Container(
                                                  child: Text(
                          ...
                          : ListView.separated(
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, prefData![index].navigationRoute, arguments: widget.journeyWithAddress);
                                  },
                                  child: ListTile(
                                    leading: Icon(
                                      IconData(int.parse(prefData![index].iconCode), fontFamily: prefData[index].iconFamily),
                                      color: Color(int.parse(prefData[index].iconColour)),
                                    ),
